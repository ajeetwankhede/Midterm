...
To create a test\+:
\begin{DoxyEnumerate}
\item Use the {\ttfamily \mbox{\hyperlink{_astar_test_8cpp_a20439c3a775a4c7b88ddba250cd8f9e4}{T\+E\+S\+T()}}} macro to define and name a test function, These are ordinary C++ functions that don\textquotesingle{}t return a value.
\end{DoxyEnumerate}
\begin{DoxyEnumerate}
...
Google Test groups the test results by test cases, so logically-\/related tests should be in the same test case; in other words, the first argument to their {\ttfamily \mbox{\hyperlink{_astar_test_8cpp_a20439c3a775a4c7b88ddba250cd8f9e4}{T\+E\+S\+T()}}} should be the same. In the above example, we have two tests, {\ttfamily Handles\+Zero\+Input} and {\ttfamily Handles\+Positive\+Input}, that belong to the same test case {\ttfamily Factorial\+Test}.
...
When using a fixture, use {\ttfamily T\+E\+S\+T\+\_\+\+F()} instead of {\ttfamily \mbox{\hyperlink{_astar_test_8cpp_a20439c3a775a4c7b88ddba250cd8f9e4}{T\+E\+S\+T()}}} as it allows you to access objects and subroutines in the test fixture\+: 
\begin{DoxyCode}{0}
...
Like {\ttfamily \mbox{\hyperlink{_astar_test_8cpp_a20439c3a775a4c7b88ddba250cd8f9e4}{T\+E\+S\+T()}}}, the first argument is the test case name, but for {\ttfamily T\+E\+S\+T\+\_\+\+F()} this must be the name of the test fixture class. You\textquotesingle{}ve probably guessed\+: {\ttfamily \+\_\+F} is for fixture.
...
{\ttfamily \mbox{\hyperlink{_astar_test_8cpp_a20439c3a775a4c7b88ddba250cd8f9e4}{T\+E\+S\+T()}}} and {\ttfamily T\+E\+S\+T\+\_\+\+F()} implicitly register their tests with Google Test. So, unlike with many other C++ testing frameworks, you don\textquotesingle{}t have to re-\/list all your defined tests in order to run them.
