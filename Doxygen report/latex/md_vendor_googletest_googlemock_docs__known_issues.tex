As any non-\/trivial software system, Google \mbox{\hyperlink{class_mock}{Mock}} has some known limitations and problems. We are working on improving it, and welcome your help! The follow is a list of issues we know about.
...
The {\ttfamily R\+E\+A\+D\+ME} file in release 1.\+1.\+0 still says that Google \mbox{\hyperlink{class_mock}{Mock}} only works with Google Test. Actually, you can configure Google \mbox{\hyperlink{class_mock}{Mock}} to work with any testing framework you choose.
